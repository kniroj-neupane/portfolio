<a
  ...
  {{
    $attributes->class([
      'py-4 px-6 md:px-9 lg:px-6 xl:px-9 rounded-full leading-normal border inline-block transition',
      ...
      'bg-red-700 border-red-600 text-white hover:bg-red-900 hover:border-red-900' => $variant === 'red',
